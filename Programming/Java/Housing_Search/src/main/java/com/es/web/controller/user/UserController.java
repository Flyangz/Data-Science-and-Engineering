package com.es.web.controller.user;
...
/**
 * <h1>用户登录和用户中心</h1>
 * Created by LiuYang on 2018/10/3 2:26 PM
 */
...
public class UserController {
    ...
    public ApiResponse subscribeList(
            ...
            @RequestParam(value = "status") int status) { // status的值在前端已经设定

        ServiceMultiResult<Pair<HouseDTO, HouseSubscribeDTO>> result = houseService
                .querySubscribeList(HouseSubscribeStatus.of(status), start, size);
